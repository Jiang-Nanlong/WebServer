...
public:
    ...
    void setReadCallback(const EventCallback& fn);

    void setWriteCallback(const EventCallback& fn);

    void setErrorCallback(const EventCallback& fn);

    void setCloseCallback(const EventCallback& fn);
